...
num_ftrs = model_ft.fc.in_features # 全結合層と前の層の状態
model_ft.fc = nn.Linear(num_ftrs, 2) # 代入して置き換える
...
model_ft = train_model(model_ft, crietion, optimizer_ft, exp_lr_scheduler, num_epochs=25)
